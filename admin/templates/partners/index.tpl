    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="tbl-cell">
                        <a href="{{ globals.uri }}partners/add/" class="btn btn-primary btn-md"><i
                                class="fa fa-plus fa-sm"></i> Add Partner</a>
                    </div>
                </div>
            ...
            <section class="box-typical">
                ...
                <div class="box-typical-body">
                  <div class="table-responsive">
                    ...
                    {% for p in partners %}
                        {% if p.image %}
                            {% set src = '<img src="' ~ constants.SITE_URL ~ 'upload/partners/' ~ p.image ~ '" height="50"/>' %}
                        {% else %}
                        ...
                        <tr data-id="{{ p.id }}">
                            ...
                            <td class="">
                                <div class="btn-group" role="group" aria-label="...">
                                    <a href="{{ globals.uri }}partners/edit/{{ p.id }}/" class="btn btn-default btn-sm"><i
                                                class="fa fa-edit"></i></a>
                                    <a href="{{ globals.uri }}partners/remove/{{ p.id }}/"
...
{% block footer %}
    ...
    <script src="{{ constants.URL }}templates/assets/views/partners/js/partners.js"></script>
{% endblock footer %}

...
(function($){
    ...
    $.fn.tagEditor = function(options, val, blur, id){
        ...
        if (typeof options == 'string') {
            ...
            selector.each(function(){
                ...
                if (options == 'getTags')
                    ...
                    // insert new tag
                    $('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag" data-id="'+id+'"></div><div class="tag-editor-delete"><i></i></div></li>').appendTo(ed).find('.tag-editor-tag')
        ...
        return selector.each(function(){
            ...
            function update_globals(init){
                ...
                tag_list = $('.tag-editor-tag:not(.deleted)', ed).map(function(i, e) {
                    ...
                    var id = $(this).data('id');
                    if (val && id != undefined) return id + '|' + val; else return val;
                }).get();
            ...
            ed.on('click', '.tag-editor-delete', function(e){
                ...
                if (o.beforeTagDelete(el, ed, tag_list, tag.text(), tag.data('id')) === false) return false;

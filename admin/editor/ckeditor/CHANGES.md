...
* [#9754](http://dev.ckeditor.com/ticket/9754): [WebKit] Cutting & pasting simple unformatted text cache_paths an inline wrapper in WebKit browsers.
...
* Context menu:
    ...
    * [#9706](http://dev.ckeditor.com/ticket/9706): Context menu cache_paths a JavaScript error in inline mode when the editor is attached to a header element.

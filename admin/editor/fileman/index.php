...
$SysPath = str_replace('/admin/editor/fileman', '', dirname($_SERVER['PHP_SELF']));
if($SysPath == "\\" || $SysPath == "/")
{
    $SysPath = '';
}
...
//set files path from  $_GET in Session
if(isset($_GET['path']))
{
    $_SESSION['files_root'] = $_GET['path'];
}
else
{
    $_SESSION['files_root'] = SYS_PATH . '/upload';
}
?>
